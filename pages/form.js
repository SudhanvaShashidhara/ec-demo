...
export default function Form() {
  ...
  return (
    <>
      {/* <Script src="https://www.googletagmanager.com/gtag/js?id=GT-KFNPS8T" /> */}

      <div className="bg-gray-50">
        <Head>
          <title>Form</title>
        </Head>
        <h1 className="max-w-7xl mx-auto text-center text-2xl py-6">Form</h1>
                ...
                {wasSubmitted ? (
                  <div className="flex justify-center items-center h-full form-submit-success">
                    ...
                    <h1 className="text-xl text-center m-auto w-10/12">
                      Thanks for submitting the form. A confirmation email is
                      sent to <span className="ec-form-email">{email}</span>. We
                      will also be contacting you at{" "}
